...
public abstract class CellularAutomataExecutor {
	...
	/**
	 * The single run is the transaction function's core.
	 * Here, you explain what happen and what your transaction function do.
	 * Consider to implement only what happen in a single cell, this behavior will be replaced for all cells of the matrix
	 * You will receive in input the single cell and its neighbors
	 * 
	 * 
