...
| 👁️ **Generation listeners** | `GenerationListener` + `GridSnapshot` for callbacks after each step |
| 🖥️ **Swing UI layer** | `CellularAutomataUIRunner` for real-time visual simulations |
